...
@section('contentsection')
    <div class="d-flex align-items-center justify-content-around">
        <h2 class="mb-0">Admin Modification Area
            <i class="fas fa-edit"></i>
        </h2>
    </div>
    <a href="{{ route('show_admins') }}" class="btn btn-secondary float-right">View Admins</a>
    <hr />
    {{-- add new course body --}}
    <div class="d-flex align-items-center justify-content-around mt-5 mb-5">
        <div class="row col-8 card shadow py-5 px-5">
            ...
            <form action="{{ route('update_admin', ['admin_id' => $adminData->id]) }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <label for="name" class="form-label">Full Name</label>
                    <input type="text" name="name" id="name"
                        class="form-control @error('name') is-invalid @enderror" placeholder="eg: Hari Pd Dhakal"
                        value="{{ isset($adminData) ? $adminData->name : old('name')  }}" aria-describedby="helpId">
                    @error('name')
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="email" id="email"
                        ...
                        value="{{ isset($adminData) ? $adminData->email : old('email') }}" aria-describedby="helpId">
                    @error('email')
                        <span class="invalid-feedback">
                            {{ $message }}
                        </span>
                ...
                <div class="form-group">
                    <label for="password" class="form-label">Set New Password <span class="text-danger text-sub">*</span></label>
                ...
                {{-- <div class="form-group">
                    ...
                    <textarea name="course_description" id="course_description"
                        class="form-control resize-vertical @error('course_description') is-invalid @enderror" rows="4"></textarea>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="phone" id="admin_phone"
                        ...
                        value="{{ isset($adminData) ? $adminData->phone : old('phone') }}" placeholder="eg: +977" aria-describedby="helpId">
                    @error('phone')
                        <span class="invalid-feedback">
                            {{ $message }}
                        </span>
                ...
                <div class="form-group mt-4">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="role_type" id="inlineRadio1"
                        value="superadmin" {{ $adminData->getRoleNames()[0] === 'superadmin' ? 'checked' : '' }}>
                        <label class="form-check-label" for="inlineRadio1">Super Admin</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="role_type" id="inlineRadio2"
                        value="admin" {{ $adminData->getRoleNames()[0] === 'admin' ? 'checked' : '' }}>
