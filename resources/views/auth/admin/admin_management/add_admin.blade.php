...
@section('contentsection')
    ...
    <div class="d-flex align-items-center justify-content-around mt-5 mb-5">
        <div class="row col-8 card shadow py-5 px-5">
            ...
            <form action="{{ route('add_newadmin') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="phone" id="admin_phone"
                ...
                <div class="form-group mt-4">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="role_type" id="inlineRadio1" value="superadmin">
