...
<body>
    <div class="container d-flex align-items-center justify-content-center" style="height: 100vh">
        <div class="text-center">
            ...
            <h1 class="error mx-auto display-1 fw-bold" data-text="429">429</h1>
            <p class="fs-3"> <span class="text-danger">Opps Too Many Request!</span></p>
            <p class="lead mb-5">
                It looks like you are attempting for brute force or something else...
              </p>
